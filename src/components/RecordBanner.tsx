...
/** 저장 직후 목표 달성 또는 개인 최고 갱신 때만 카드 아래에 한 줄. 1.5초 뒤 사라진다. */
export function RecordBanner({ best, goalReached = false, celebrateTick }: Props) {
  ...
  const message = celebrateTick > dismissed ? celebrationMessage(goalReached, best) : null;
