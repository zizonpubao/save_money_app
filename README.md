...
![Jest](https://img.shields.io/badge/Tests-427%20passing-C21325?logo=jest&logoColor=white)
...
| 유스케이스 | 트리거 | 결과 |
|---|---|---|
| 참은 소비 기록하기 | 홈의 `+` | 기록 저장, 햅틱 + 카운트업 + 펄스. 최고 기록·목표 달성 시 배너 |
...
| 6 | 홈 활기 | 오늘의 한 줄(명언 · 환산 · 어제 대비), 하루 첫 오픈 카운트업, 이번 달 잔디, 이모지 적립 |
...
적용된 마이그레이션은 고치지 않고 새 버전을 덧붙입니다 (v1 초기 스키마 → v2 밥값 카테고리 → v3 settings).
